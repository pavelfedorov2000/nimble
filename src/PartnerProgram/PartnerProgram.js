...
function PartnerProgram(props) {
    ...
    return (
        <section id="section-2" className="partner-program">
                            ...
                            <ol className="partner-program__levels levels">
                                {levels.map((level, i) => (
                                    <li className="levels__item level">
                                        ...
                                        <div className="level__descr mob-visible" style={{ color: genegateColor(level.percent) }}>
                                            {i == 0 ? "покупка" : "оборот"} от {level.from}
                                        </div>
